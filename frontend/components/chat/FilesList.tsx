import { FileCode, Folder, ChevronRight, ChevronDown, ExternalLink } from "lucide-react";
...
function FileTreeNode({ node, appUrl, depth = 0 }: { node: FileNode; appUrl: string | null; depth?: number }) {
    ...
    <div className="h-full overflow-y-auto p-4">
      <div className="mb-4 pb-3 border-b border-white/10">
        ...
        <p className="text-white/50 text-xs mt-1">
          {files.length} file{files.length !== 1 ? 's' : ''} • Click to open in new tab
        </p>
      </div>
