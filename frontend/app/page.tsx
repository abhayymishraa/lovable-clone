...
import { FaReact, FaCode, FaMagic, FaRocket, FaBolt, FaCheckCircle } from "react-icons/fa"
...
export default function Home() {
  return (
    <div className="min-h-screen w-full relative overflow-hidden" style={{ backgroundColor: '#0a0a0a' }}>
      ...
      {/* Main Content */}
      <main className="landing-page-wrapper w-full font-sans overflow-x-hidden relative z-10"
        style={{
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-neutral-400 mb-8 max-w-2xl mx-auto text-balance">
            Transform your ideas into production-ready React applications. Just describe what you want to build, and our AI agent handles the rest.
          </p>
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <span className="text-neutral-400">Join thousands of developers</span>
          </div>
      ...
      <section className="py-16 px-6 border-t border-neutral-800">
        <div className="max-w-6xl mx-auto">
          <p className="text-center text-neutral-500 mb-12">Powered by cutting-edge AI technology</p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            <div className="flex flex-col items-start">
              ...
              <p className="text-neutral-500">Let AI write your code, set up routing, and configure your entire React application</p>
            </div>
            <div className="flex flex-col items-start">
              <MdSpeed size={32} className="mb-4 text-neutral-400" />
              <h3 className="text-lg font-semibold mb-2">Lightning Fast</h3>
              <p className="text-neutral-500">Go from idea to deployed application in minutes, not days or weeks</p>
            </div>
            <div className="flex flex-col items-start">
              <FaBolt size={32} className="mb-4 text-neutral-400" />
              <h3 className="text-lg font-semibold mb-2">Real-time Preview</h3>
              <p className="text-neutral-500">See your application come to life in real-time as the AI builds it</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 border-t border-neutral-800">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl md:text-6xl font-bold mb-4 text-balance">Build smarter.</h2>
            <p className="text-4xl md:text-5xl font-bold text-neutral-600 mb-6 text-balance">Code faster.</p>
            <p className="text-xl text-neutral-400 text-balance">
              Our AI agent understands your requirements and builds complete React applications with proper architecture.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="border border-neutral-800 rounded-2xl p-8 bg-neutral-900/30 hover:bg-neutral-900/50 transition">
              <h3 className="text-2xl font-semibold mb-3">Describe your app</h3>
              <p className="text-neutral-400 mb-8">Tell the AI what you want to build in natural language - no technical jargon required.</p>
              <div className="bg-black rounded-lg p-6 mb-6 h-40 border border-neutral-700 flex items-center justify-center">
                <div className="text-center text-neutral-600">
                  ...
                  <p className="text-sm">"Build a todo app with drag-and-drop"</p>
                </div>
              </div>
            ...
            <div className="border border-neutral-800 rounded-2xl p-8 bg-neutral-900/30 hover:bg-neutral-900/50 transition">
              ...
              <p className="text-neutral-400 mb-8">See your application being created in real-time with live preview.</p>
              <div className="bg-black rounded-lg p-6 mb-6 border border-neutral-700">
                <div className="space-y-3">
                  ...
                  <div className="text-xs text-neutral-600 px-3">Building your app</div>
                  <div className="space-y-2 ml-1">
                    {["App.jsx", "TodoList.jsx", "TodoItem.jsx", "styles.css"].map((file, i) => (
                      <div key={file} className="text-neutral-500 text-sm flex items-center gap-2">
      ...
      <section className="py-20 px-6 border-t border-neutral-800">
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            {/* AI-Powered Section */}
            <div className="border border-neutral-800 rounded-2xl p-8 bg-neutral-900/30 hover:bg-neutral-900/50 transition">
              <h3 className="text-2xl font-semibold mb-3">Intelligent code generation</h3>
              <p className="text-neutral-400 mb-8">
                Our AI doesn't just generate code - it understands best practices, proper architecture, and modern React patterns.
              </p>
              <div className="bg-black rounded-lg p-6 space-y-3">
                {[
                  ...
                  <div key={i} className="text-neutral-600 text-sm flex items-start gap-3">
                    <FaCheckCircle size={16} className="mt-1 text-green-500" />
                    <span>{feature}</span>
                  </div>
                ))}
              </div>
            ...
            {/* Iterate Section */}
            <div className="border border-neutral-800 rounded-2xl p-8 bg-neutral-900/30 hover:bg-neutral-900/50 transition">
              <h3 className="text-2xl font-semibold mb-3">Iterate with conversation</h3>
              <p className="text-neutral-400 mb-8">Chat with the AI to refine your application. Add features, fix bugs, or change designs.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-start">
              ...
              <p className="text-neutral-500 text-sm">Generate code that follows industry best practices and standards.</p>
            </div>
            <div className="flex flex-col items-start">
              <FaRocket size={24} className="mb-3 text-neutral-400" />
              <h4 className="font-semibold mb-2">Deploy instantly</h4>
              <p className="text-neutral-500 text-sm">Download your project and deploy to any hosting platform in minutes.</p>
            </div>
            <div className="flex flex-col items-start">
              <MdBuild size={24} className="mb-3 text-neutral-400" />
              <h4 className="font-semibold mb-2">Full control</h4>
              <p className="text-neutral-500 text-sm">Own your code completely. Modify, extend, or customize as you wish.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 border-t border-neutral-800">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl md:text-6xl font-bold mb-4 text-balance">Modern stack.</h2>
            <p className="text-4xl md:text-5xl font-bold text-neutral-600 mb-6 text-balance">Battle-tested tools.</p>
            <p className="text-xl text-neutral-400 text-balance">
              Built with the most popular and reliable technologies in the React ecosystem.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="border border-neutral-800 rounded-2xl p-8 bg-neutral-900/30 hover:bg-neutral-900/50 transition">
              ...
              <p className="text-neutral-400 mb-8">
                Lightning-fast development with Vite's instant HMR and React's component-based architecture.
              </p>
              <div className="bg-black rounded-lg p-6 space-y-3">
                ...
                <div className="text-xs text-neutral-700 px-2">Fast refresh, optimized builds</div>
            ...
            {/* Tailwind CSS */}
            <div className="border border-neutral-800 rounded-2xl p-8 bg-neutral-900/30 hover:bg-neutral-900/50 transition">
              <h3 className="text-2xl font-semibold mb-3">Tailwind CSS & React Icons</h3>
              <p className="text-neutral-400 mb-8">
                Utility-first CSS framework with a comprehensive icon library for rapid UI development.
              </p>
          ...
          <div className="border border-neutral-800 rounded-2xl p-8 bg-neutral-900/30">
            <h3 className="text-2xl font-semibold mb-3">AI-Powered Architecture</h3>
            <p className="text-neutral-400">
              Our AI agent doesn't just generate code - it architects your entire application with proper structure and best practices.
            </p>
            <div className="mt-6 text-neutral-500 text-sm p-4 bg-black rounded-lg border border-neutral-700">
              <p>✓ Component organization • State management • Routing setup</p>
      ...
      <section className="py-16 px-6 border-t border-neutral-800">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-start">
              <AiFillThunderbolt size={28} className="mb-4 text-neutral-400" />
              <h3 className="text-lg font-semibold mb-2">Blazing fast development</h3>
              <p className="text-neutral-500">Go from idea to deployed application in minutes, not days.</p>
            </div>
            <div className="flex flex-col items-start">
              <FaCode size={28} className="mb-4 text-neutral-400" />
              <h3 className="text-lg font-semibold mb-2">Clean, readable code</h3>
              <p className="text-neutral-500">Generated code follows best practices and is easy to understand.</p>
            </div>
            <div className="flex flex-col items-start">
              <FaRocket size={28} className="mb-4 text-neutral-400" />
              <h3 className="text-lg font-semibold mb-2">Deploy anywhere</h3>
              <p className="text-neutral-500">Export your project and deploy to Vercel, Netlify, or any platform.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 border-t border-neutral-800">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="text-5xl md:text-6xl font-bold mb-8 text-balance">Start building with AI today.</h2>
          <Link href="/chat">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between mb-8 pb-8 border-b border-neutral-800">
            <div className="flex items-center gap-2 mb-6 md:mb-0">
              ...
              <span className="text-xs px-2 py-1 rounded-full border border-neutral-700 text-neutral-500">BETA</span>
            </div>
            <nav className="flex items-center gap-8 text-neutral-400 text-sm">
              ...
              <a href="https://github.com/abhayymishraa/lovable-clone" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">
                GitHub
              </a>
            </nav>
          </div>
