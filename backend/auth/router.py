...
@router.post("/register", response_class=UserResponse, status_code=status.HTTP_201_CREATED)
...
async def refresh_token(
    ...
    acccess_token = create_access_token(data={
        "sub": str(user.id)
    })
